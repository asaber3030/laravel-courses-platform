...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello,</p>
      <p>You requested a verification for your account. To verify your account, please use the following code:</p>

      <div class="reset-code">
        {{ $code }}
      </div>

      <p>If you didn't request this, please ignore this email. Your account state will not be changed.</p>
